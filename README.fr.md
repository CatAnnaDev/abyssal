...
- Sept biomes (Cavernes, Catacombes, Glacier, Tréfonds, Abîme, Jardins Fongiques, Forge en Ruine), chacun avec sa palette, sa teinte d'éclairage, sa faune biaisée, un danger ambiant, un champion thématique, une couche de décor au sol (mousse, eau, ossements, fissures, glace, braises, motes du vide) et sa tonalité musicale

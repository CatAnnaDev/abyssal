...
- Variante Boss Rush (option du menu) : les étages 1 à 9 sont normaux pour se stuffer, puis à partir de l'étage 10 chaque étage est gardé par un boss — un gant de fer enchaîné, boss après boss, avec un minimum de trash

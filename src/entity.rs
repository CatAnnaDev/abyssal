...
pub const CLASSES: &[ClassDef] = &[
    ClassDef { class: HeroClass::Warrior,      label: "Guerriere",      crit: 0.10, cleave: 2,   bolt: 999, bleeds: false, raises: false, weapon: WeaponClass::Heavy, armor: ArmorClass::Plate,   d_hp: 14, d_might: 0, d_guard: 2, ability: Ability::Charge },
    ClassDef { class: HeroClass::Rogue,        label: "Voleuse",        crit: 0.28, cleave: 999, bolt: 6,   bleeds: true,  raises: false, weapon: WeaponClass::Light, armor: ArmorClass::Leather, d_hp: 0,  d_might: 3, d_guard: 0, ability: Ability::Blink },
    ...
    ClassDef { class: HeroClass::Paladin,      label: "Paladine",       crit: 0.12, cleave: 3,   bolt: 999, bleeds: false, raises: false, weapon: WeaponClass::Heavy, armor: ArmorClass::Plate,   d_hp: 20, d_might: 1, d_guard: 3, ability: Ability::Smite },
    ClassDef { class: HeroClass::Necromancer,  label: "Necromancienne",  crit: 0.13, cleave: 999, bolt: 1,   bleeds: false, raises: true,  weapon: WeaponClass::Staff, armor: ArmorClass::Cloth,   d_hp: 8,  d_might: 3, d_guard: 0, ability: Ability::Raise },
    ClassDef { class: HeroClass::Ranger,       label: "Rodeuse",        crit: 0.20, cleave: 999, bolt: 1,   bleeds: false, raises: false, weapon: WeaponClass::Bow,   armor: ArmorClass::Leather, d_hp: 4,  d_might: 3, d_guard: 0, ability: Ability::Volley },
    ...
    ClassDef { class: HeroClass::Druid,        label: "Druidesse",        crit: 0.14, cleave: 999, bolt: 1,   bleeds: false, raises: false, weapon: WeaponClass::Staff, armor: ArmorClass::Leather, d_hp: 10, d_might: 4, d_guard: 0, ability: Ability::Smite },
    ClassDef { class: HeroClass::Templar,      label: "Templiere",      crit: 0.12, cleave: 3,   bolt: 999, bleeds: false, raises: false, weapon: WeaponClass::Heavy, armor: ArmorClass::Mail,    d_hp: 18, d_might: 1, d_guard: 3, ability: Ability::Charge },
    ...
    ClassDef { class: HeroClass::Shaman,       label: "Chamane",        crit: 0.15, cleave: 999, bolt: 1,   bleeds: false, raises: false, weapon: WeaponClass::Staff, armor: ArmorClass::Leather, d_hp: 8,  d_might: 4, d_guard: 1, ability: Ability::Smite },
    ...
    ClassDef { class: HeroClass::Reaper,       label: "Faucheuse",      crit: 0.22, cleave: 2,   bolt: 999, bleeds: true,  raises: false, weapon: WeaponClass::Light, armor: ArmorClass::Leather, d_hp: 6,  d_might: 5, d_guard: 0, ability: Ability::Furie },

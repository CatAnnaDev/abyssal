...
pub const BIOMES: &[BiomeDef] = &[
    ...
    BiomeDef {
        biome: Biome::Ashsea,
        label: "Mer de Cendres",
        tint: (1.18, 0.92, 0.78),
        element: Some(Element::Fire),
        map_style: 3,
        music_style: 3,
        fauna: &['w', 'D', 'i', 'e', 'z', 'P', 'y'],
        lore: "Une plaine de cendre grise ondule sous un ciel rougeoyant.",
        champion: ('D', "Phenix de Suie", Element::Fire),
        weight_peak: 12,
        weight_center: 22,
        weight_min: 1,
        palette: (((176, 150, 128), (96, 78, 64)), ((84, 72, 66), (36, 30, 27))),
        ambient: ('\u{00b7}', (220, 180, 150), 0.04),
    },
    BiomeDef {
        biome: Biome::Mire,
        label: "Marais Putride",
        tint: (0.84, 1.08, 0.82),
        element: Some(Element::Poison),
        map_style: 0,
        music_style: 1,
        fauna: &['j', 'v', 'k', 'c', 'n', 's', 'G'],
        lore: "Une fange tiede happe vos pas, gorgee de miasmes verts.",
        champion: ('v', "Behemoth des Tourbieres", Element::Poison),
        weight_peak: 11,
        weight_center: 7,
        weight_min: 1,
        palette: (((104, 132, 96), (44, 66, 42)), ((48, 64, 46), (20, 30, 22))),
        ambient: ('\u{00b0}', (150, 200, 120), -0.05),
    },
    BiomeDef {
        biome: Biome::Starvault,
        label: "Voute Stellaire",
        tint: (1.0, 0.94, 1.24),
        element: Some(Element::Lightning),
        map_style: 4,
        music_style: 4,
        fauna: &['Y', 'x', 'A', 'Q', 'B', 'E', 'D'],
        lore: "Le plafond s'ouvre sur un gouffre constelle qui aspire le regard.",
        champion: ('A', "Astre Devoreur", Element::Lightning),
        weight_peak: 12,
        weight_center: 28,
        weight_min: 1,
        palette: (((132, 132, 178), (58, 60, 98)), ((54, 56, 92), (22, 24, 44))),
        ambient: ('\u{2727}', (190, 195, 255), 0.10),
    },
    BiomeDef {
        biome: Biome::Necropolis,
        label: "Necropole Doree",
        tint: (1.12, 1.04, 0.78),
        element: Some(Element::Poison),
        map_style: 1,
        music_style: 1,
        fauna: &['s', 'h', 'T', 'G', 'N', 'k', 'R'],
        lore: "L'or terni des tombeaux luit faiblement dans la poussiere des rois.",
        champion: ('T', "Pharaon Embaume", Element::Poison),
        weight_peak: 12,
        weight_center: 10,
        weight_min: 1,
        palette: (((164, 150, 104), (90, 80, 48)), ((72, 66, 48), (30, 27, 18))),
        ambient: ('\u{00b7}', (220, 200, 130), -0.02),
    },
];
...
impl Game {
    ...
    fn tick_hero_statuses(&mut self) {
        ...
        match self.biome {
            ...
            Biome::Ashsea if self.rng.chance(0.05) => self.hero.burn = self.hero.burn.max(2),
            Biome::Mire if self.rng.chance(0.06) => self.hero.poison = self.hero.poison.max(2),
